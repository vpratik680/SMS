...
if (isset($_POST["submit"]))
{
	...
	$p1="insert into student(user_id,name,email_id,user_type,password,gender,phone_no,department) values (' ','$name','email_id','$user_type','$password','$Confirm_pass',$gender','$phone_no','$department')";
	
	$p=mysqli_query($conn,$p1);
	if($p)
	{
		echo "Success";
	}
...
<!-- Mirrored from limpidthemesdemo.com/Themeforest/html/Pathshala/Pathshala-HTML/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Aug 2018 07:49:08 GMT -->
<head>
				...
				<div class="top-navbar">
					<div class = "pull-right">
						...
						<div class="top-nav-login-btn pull-right">
							<a href="#" data-toggle="modal" data-target="#loginModal"><i class="fa fa-sign-in"></i>SIGN UP</a>
						</div>
                ...
                <nav id="pathshalaNavbar" class="navbar navbar-default" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="pathshalaNavbarCollapse">
                        <ul class="nav navbar-nav">
							...
							<li class="dropdown">
                                <a href="events.html" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-calendar-check-o"></i>EVENTS <b class="caret"></b></a>
                                <ul class="dropdown-menu">
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content login-modal">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-sign-in"></i>SIGN UP</h4>
					</div>
					<div class="modal-body">
						...
						<div>
							<label><i class="fa fa-transgender-alt"></i>Gender</label><br>
							<p><input type="radio" value="male"name="gender" ><label>Male</label>
							<input type="radio" value="female"name="gender"><label>Female</label>
						</div>
						<div>
							<label><i class="fa fa-building"></i>Who Are You?</label>
							<select name="user_type" class="form-control">
								<option value="faculty" class="form-control">Faculty</option>
						...
						<div>
							<label><i class="fa fa-phone"></i>Phone-No.</label>
						...
						<div>
							...
							<select name="department" class="form-control">
								...
								<option value="IT" class="form-control">Information-Technology</option>
								<option value="Electrical" class="form-control">Electrical</option>
							</select>
								
						</div>
					
						<input type="submit" name="submit" class="login-link"><i class="fa fa-sign-in"></i>SIGN UP</a>
					</div>
				</div>
			</div>
...
<!-- Mirrored from limpidthemesdemo.com/Themeforest/html/Pathshala/Pathshala-HTML/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Aug 2018 07:50:57 GMT -->
</html>